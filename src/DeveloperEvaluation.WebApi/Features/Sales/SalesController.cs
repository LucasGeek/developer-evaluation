...
using DeveloperEvaluation.WebApi.Features.Sales.ListSales;
using DeveloperEvaluation.WebApi.Features.Sales.UpdateSale;
using DeveloperEvaluation.WebApi.Features.Sales.CancelSale;
using DeveloperEvaluation.WebApi.Features.Sales.CancelSaleItem;
using AutoMapper;
using MediatR;
