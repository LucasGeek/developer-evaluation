...
public interface ICartRepository
{
    ...
    Task<PaginatedList<Cart>> GetByUserIdRangeAsync(int startUserId, int endUserId, int page = 1, int limit = 20, string? sort = null, CancellationToken cancellationToken = default);
