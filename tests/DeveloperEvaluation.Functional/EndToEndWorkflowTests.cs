...
using DeveloperEvaluation.Integration;
using DeveloperEvaluation.WebApi.Features.Auth.AuthenticateUserFeature;
using DeveloperEvaluation.WebApi.Features.Carts;
using DeveloperEvaluation.WebApi.Features.Products;
...
namespace DeveloperEvaluation.Functional;
