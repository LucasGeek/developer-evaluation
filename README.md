...
The API manages a **Sales System** for Ambev's product catalog, handling:

- **Sales Management**: Complete CRUD operations for sales records
- **Product Catalog**: Ambev beverage and snack inventory
...
1. **Clone the repository**
   ...
   cd ambev-developer-evaluation/template/backend
   ```
...
dotnet ef migrations add MigrationName -p src/Ambev.DeveloperEvaluation.ORM -s src/Ambev.DeveloperEvaluation.WebApi

# Apply migrations
dotnet ef database update -p src/Ambev.DeveloperEvaluation.ORM -s src/Ambev.DeveloperEvaluation.WebApi

# Reset database
dotnet ef database drop -p src/Ambev.DeveloperEvaluation.ORM -s src/Ambev.DeveloperEvaluation.WebApi
```
...
#### 👥 **Users (5 total)**
- **1 Admin**: `admin@ambev.com` / `Admin123!`
- **1 Manager**: `manager@ambev.com` / `Manager123!`
- **3 Customers**: `customer1@ambev.com`, `customer2@ambev.com`, `customer3@ambev.com` / `Customer123!`

#### 🍺 **Products (17 total)**
Authentic **Ambev product catalog** including:
...
└── Ambev.DeveloperEvaluation.Functional/  # API tests
```
...
- **GitHub Issues**: [Create an issue](https://github.com/your-username/ambev-developer-evaluation/issues)
...
**Built with ❤️ for Ambev Developer Evaluation**
